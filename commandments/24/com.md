...
My PC’s beefy. Fusion’s been the only program capable of freezing my entire machine.

> [!TIP]
> This is very likely to happen with large parametric models. Switch to direct, and only use parametric when absolutely required, such as when balancing an Asymmetric Spinner.
